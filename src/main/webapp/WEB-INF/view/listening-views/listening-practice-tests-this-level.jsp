...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/listening-practice-tests-this-level/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/listening-practice-tests-this-level/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/listening-practice-tests-this-level/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/listening-practice-tests-this-level/nicepage.js"/>" defer=""></script>
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
            <div class="u-container-layout u-container-layout-1">
                <h1 class="u-align-center u-text u-text-body-alt-color u-text-1" data-lang-en="​Lessons &amp;amp; Practice">LISTENING PRACTICE<br>${tasksAtt.get(0).level} LEVEL&nbsp;
                </h1>
            </div>
        </div>
        ...
        <c:forEach var="task" items="${tasksAtt}">
            ...
            <c:url var="showTask" value="/listening/showTask">
                <c:param name="taskId" value="${task.id}"/>
            </c:url>
            <h5 class="u-align-right u-custom-font u-font-roboto-slab u-hover-feature u-text u-text-default u-text-3" onClick="window.location.href='${showTask}'" style="cursor: pointer;">${task.title}</h5>
        ...
        <%--<h5 class="u-align-right u-custom-font u-font-roboto-slab u-hover-feature u-text u-text-default u-text-2">Example 1</h5>
        <h5 class="u-align-right u-custom-font u-font-roboto-slab u-hover-feature u-text u-text-default u-text-3">Example 2</h5>
        <h5 class="u-align-right u-custom-font u-font-roboto-slab u-hover-feature u-text u-text-default u-text-4">Example 3</h5>
    --%>    <p class="u-align-right u-text u-text-body-alt-color u-text-default u-text-5" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-direction="Up" data-animation-delay="750" data-lang-en="Image from <a href=&quot;https://www.freepik.com/photos/woman&quot; class=&quot;u-active-none u-border-2 u-border-active-palette-3-base u-border-hover-palette-3-base u-border-no-left u-border-no-right u-border-no-top u-border-white u-btn u-button-link u-button-style u-hover-none u-none u-text-body-alt-color u-block-e964-116&quot; style=&quot;border-style: solid; padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 0&quot;>Freepik</a>">&nbsp;&nbsp;<br>
        </p>
    </div>
