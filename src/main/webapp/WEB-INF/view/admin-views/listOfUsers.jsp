...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
  ...
  <div class="u-table u-table-responsive u-table-1">
    <table class="u-table-entity">
      ...
      <tr style="height: 46px;">
        ...
        <th class="u-border-1 u-border-grey-dark-1 u-table-cell">SURNAME</th>
        <th class="u-border-1 u-border-grey-dark-1 u-table-cell">EMAIL</th>
        <th class="u-border-1 u-border-grey-dark-1 u-table-cell">PHONE</th>
        <th class="u-border-1 u-border-grey-dark-1 u-table-cell">LEVEL</th>
      ...
      <tr style="height: 56px;">
        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">${us.name}</td>
        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">${us.surname}</td>
        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">${us.email}</td>
        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">${us.mobile}</td>
        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">${us.level}</td>
        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">
          <c:choose>
            <c:when test="${us.enabled}">
              active
              <input type="button" value="BAN" onClick="window.location.href='${banButton}'" style="color:black"/>
            </c:when>
            <c:otherwise>
              banned
              <input type="button" value="UNBAN" onClick="window.location.href='${ubBanButton}'" style="color:black"/>
            </c:otherwise>
          </c:choose>
        </td>
      </tr>
  ...
  <div class="u-container-align-center u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
    <a href="/homeReff"><div class="u-container-layout u-valign-middle u-container-layout-2">
      <h5 class="u-align-center u-text u-text-default u-text-palette-1-base u-text-2">BACK<span style="font-size: 1.875rem;"></span>
      </h5>
    </div></a>
  </div>
</section>
