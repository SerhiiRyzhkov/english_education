...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/test-start-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/test-start-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/test-start-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/test-start-view/nicepage.js"/>" defer=""></script>
    ...
    <meta property="og:title" content="${typeAtt}">
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
            <div class="u-container-layout u-container-layout-1">
                <h1 class="u-align-center u-text u-text-body-alt-color u-text-default u-text-1" data-lang-en="​Lessons &amp;amp; Practice"> ${typeAtt.toUpperCase()} PRACTICE<br>A2 LEVEL
                </h1>



                <c:if test="${typeAtt=='Grammar'}">
                    <h4 class="u-align-center u-text u-text-2"> Welcome to the English Grammar Test! This test is designed to assess your understanding of English grammar rules and usage. Before starting the test, take a deep breath, relax, and remember that you have prepared for this moment. Trust in yourself and your abilities, and do your best to answer each question to the best of your ability. Remember, there is no time limit, so take your time and read each question carefully. Good luck, and we hope you enjoy the test!</h4>
                </c:if>
                <c:if test="${typeAtt=='Vocabulary'}">
                    <h4 class="u-align-center u-text u-text-2"> Welcome to the English Vocabulary Test! This test is designed to assess your knowledge of English words and their meanings. Before starting the test, take a deep breath, relax, and remember that you have prepared for this moment. Trust in yourself and your abilities, and do your best to answer each question to the best of your ability. Remember, there is no time limit, so take your time and read each question carefully. Good luck, and we hope you enjoy the test!</h4>
        ...
        <form:form name="startForm" action="/GV/test">

        </form:form>

        <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
            <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['startForm'].submit();" style="cursor: pointer;">



                <h5 class="u-text u-text-default u-text-palette-1-base u-text-3" >START </h5>
