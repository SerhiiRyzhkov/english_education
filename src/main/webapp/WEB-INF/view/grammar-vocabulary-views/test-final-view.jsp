...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <title>${typeAtt} practice</title>
    <link rel="stylesheet" href="<c:url value="/resources/style/show-listening-test-result/nicepage.css"/>" media="screen">


    <link rel="stylesheet" href="<c:url value="/resources/style/show-listening-test-result/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/show-listening-test-result/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/show-listening-test-result/nicepage.js"/>" defer=""></script>
...
<body data-home-page="${typeAtt}.html" data-home-page-title="${typeAtt}" class="u-body u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-fe69"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
            <div class="u-container-layout u-container-layout-1">
                <h1 class="u-align-center u-text u-text-body-alt-color u-text-default u-text-1" data-lang-en="​Lessons &amp;amp; Practice"> ${typeAtt.toUpperCase()} PRACTICE<br>${curTaskAtt.level}  LEVEL
                </h1>
                <h3 class="u-align-center u-text u-text-2">Your result: ${userPointsAtt}/${totalPointsAtt} points</h3>
                ...
                <h4 class="u-align-center u-text u-text-3"> Thank you for completing your English Test! While your score of ${userPointsAtt} out of ${totalPointsAtt} points may not be what you had hoped for, it's important to remember that language learning takes time and effort. Don't be discouraged, keep practicing and working on your language skills, and you will see progress in no time. We are here to support you on your language learning journey and offer resources to help you improve. Remember, every attempt is an opportunity to learn and grow. Keep up the good work, and don't give up!
                    ...
                    <h4 class="u-align-center u-text u-text-3"> Congratulations! You have scored ${userPointsAtt} out of ${totalPointsAtt} points in your English Test. Don't be discouraged if your score is not as high as you had hoped. Remember that language learning is a journey, and every step forward is progress. Keep practicing and working on your skills, and you will see improvement in no time. Keep up the great work!</h4>

                    </c:when>
                    <c:when test="${resultAtt == 3}">
                    <h4 class="u-align-center u-text u-text-3"> Fantastic news! You have aced your English Test with an impressive score of ${userPointsAtt} out of ${totalPointsAtt} points. This is a remarkable achievement, and you should be proud of yourself. You have demonstrated an excellent command of the English language, and your hard work and dedication have paid off. Keep up the excellent work, and continue to practice and improve your skills. Congratulations once again on your outstanding performance!
        ...
        <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
            <a href="/${typeAtt.toLowerCase()}Reff"><div class="u-container-layout u-container-layout-2"  style="left: 75%;">
                <h5 class="u-align-center u-text u-text-default u-text-palette-1-base u-text-4">${typeAtt}</h5>
            </div> </a>
        </div>
