...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    ...
    <form:form action="/irregular/check" modelAttribute="verbsAtt" name="checker">
    <div class="u-table u-table-responsive u-table-1" id="answers">
        <table class="u-table-entity">
            ...
            <tr style="height: 46px;">
                <td class="u-border-3 u-border-white u-table-cell u-table-cell-4">${verb.base}</td>
                <td class="u-border-3 u-border-white u-table-cell u-table-cell-5"><input type="text" name="${uStatus.index}_past" autocomplete="off" style="color:black"/></td>
                <td class="u-border-3 u-border-white u-table-cell u-table-cell-6"><input type="text" name="${uStatus.index}_participle" autocomplete="off" style="color:black"/></td>
            </tr>
            </c:forEach>
    ...
    <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
        <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['checker'].submit();" style="cursor:pointer">
            <h5 class="u-text u-text-default u-text-palette-1-base u-text-2" >CHECK</h5>
        </div>
    </div>
