...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/start-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/start-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/start-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/start-view/nicepage.js"/>" defer=""></script>
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
            <div class="u-container-layout u-container-layout-1">
                ...
                <h4 class="u-align-center u-text u-text-2"> Irregular verbs are verbs that do not follow the normal patterns for tense and past participle. While most English regular verbs use the ending "-ed" for the past tense and participle forms, irregular verbs each have their own unique tense forms and past participles. Irregular verbs are one of the hardest parts of the modern English language because they`re all a little different. Since there`s no formula, English speakers have no choice but to memorize each one, along with their special verb forms.</h4>
            </div>
        </div>


        <form:form action="showVerbs/" name="showVerbs">

        </form:form>


        <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
            <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['showVerbs'].submit();" style="cursor:pointer">
                <h5 class="u-text u-text-default u-text-palette-1-base u-text-3">SHOW VERBS</h5>
            </div>
        </div>

        <form:form action="practiseVerbs/" name="practice">

        </form:form>

        <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-3" onClick="document.forms['practice'].submit();" style="cursor:pointer">
            <div class="u-container-layout u-valign-middle u-container-layout-3">
                <h5 class="u-text u-text-default u-text-palette-1-base u-text-4"> PRACTICE</h5>
            </div>
        </div>
    </div>
</section>
