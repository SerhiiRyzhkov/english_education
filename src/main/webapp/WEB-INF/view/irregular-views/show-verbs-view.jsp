...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Verbs &amp;amp; Practice, ​Meet some of our partners!, ​Integrity. Uniqueness. Enjoyment. Ever Forward., ​Our Mission, Contact Us">
    <meta name="description" content="">
    <title>Irregular verbs</title>
    <link rel="stylesheet" href="<c:url value="/resources/style/show-verbs-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/show-verbs-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/show-verbs-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/show-verbs-view/nicepage.js"/>" defer=""></script>
...
<body data-home-page="Verbs.html" data-home-page-title="Verbs" class="u-body u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-fe69"><div class="u-clearfix u-sheet u-sheet-1">
...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    <div class="u-bottom-left-radius-19 u-container-style u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
        <div class="u-container-layout u-container-layout-1">
            <h1 class="u-align-center u-text u-text-body-alt-color u-text-default u-text-1" data-lang-en="​Lessons &amp;amp; Practice"> IRREGULAR VERBS</h1>
        </div>
    </div>
        ...
        <table class="u-table-entity">
            ...
            <c:forEach var="verb" items="${allVerbsAtt}">
                <tr style="height: 46px;">
                    ...
                    <td class="u-border-3 u-border-white u-table-cell u-table-cell-5">${verb.past}</td>
                    <td class="u-border-3 u-border-white u-table-cell u-table-cell-6">${verb.participle}</td>
                </tr>
            </c:forEach>
    ...
    <form:form action="/irregular/" name="irregular">
    </form:form>

    <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2" >
        <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['irregular'].submit();" style="cursor:pointer">
            <h5 class="u-text u-text-default u-text-palette-1-base u-text-2">BACK</h5>
        </div>
    </div>
</section>
