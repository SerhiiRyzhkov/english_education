...
<html style="font-size: 16px;" lang="ru"><head>
  ...
  <link rel="stylesheet" href="<c:url value="/resources/style/practice-view/nicepage.css"/>" media="screen">
  <link rel="stylesheet" href="<c:url value="/resources/style/practice-view/Main.css"/>" media="screen">
<%--  <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/practice-view/jquery.js"/>" defer=""></script>
  <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/practice-view/nicepage.js"/>" defer=""></script>--%>
...
<body data-home-page="Irregular.html" data-home-page-title="Irregular" class="u-body u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-fe69"><div class="u-clearfix u-sheet u-sheet-1">
...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
  <div class="u-bottom-left-radius-19 u-container-style u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
    <div class="u-container-layout u-container-layout-1">
      <h1 class="u-align-center u-text u-text-body-alt-color u-text-default u-text-1" data-lang-en="​Lessons &amp;amp; Practice"> IRREGULAR VERBS<br>PRACTISE
      </h1>
    </div>
  </div>

  <form:form action="/irregular/next" modelAttribute="verbsAtt" name="checker">
  <div class="u-table u-table-responsive u-table-1" id="answers">
    <table class="u-table-entity">
      ...
      <thead class="u-align-center u-custom-font u-font-roboto-slab u-table-header u-text-palette-1-base u-white u-table-header-1">
      <tr style="height: 29px;">
        <th class="u-border-3 u-border-black u-table-cell">BASE</th>
        <th class="u-border-3 u-border-black u-table-cell">PAST</th>
        <th class="u-border-3 u-border-black u-table-cell">PARTICIPLE</th>
      </tr>
      </thead>
      ...
      <c:forEach var="verb" items="${verbsAtt}" varStatus="uStatus">
        <tr style="height: 46px;">
          ...
          <c:if test="${verb.value}">
            ...
            <td class="u-border-3 u-border-white u-table-cell u-table-cell-4" style="color: yellowgreen">${verb.key.base}</td>
          </c:if>
          <c:if test="${!verb.value}">
            <td class="u-border-3 u-border-white u-table-cell u-table-cell-4" style="color: red">${verb.key.base}</td>
          </c:if>

          <c:if test="${verb.value}">
            <td class="u-border-3 u-border-white u-table-cell u-table-cell-5" style="color: yellowgreen">${verb.key.past}</td>

          </c:if>
          <c:if test="${!verb.value}">
            <td class="u-border-3 u-border-white u-table-cell u-table-cell-5" style="color: red">${verb.key.past}</td>
          </c:if>

          <c:if test="${verb.value}">
            <td class="u-border-3 u-border-white u-table-cell u-table-cell-6" style="color: yellowgreen">${verb.key.participle}</td>

          </c:if>
          <c:if test="${!verb.value}">
            <td class="u-border-3 u-border-white u-table-cell u-table-cell-6" style="color: red">${verb.key.participle}</td>
          </c:if>
  ...
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
    <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['checker'].submit();" style="cursor:pointer">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-2" >NEXT</h5>
    </div>
  </div>

  <form:form action="/irregular/" name="goBack">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-3">
    <div class="u-container-layout u-valign-middle u-container-layout-3" onClick="document.forms['goBack'].submit();" style="cursor:pointer">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-3" >BACK</h5>
    </div>
  </div>
