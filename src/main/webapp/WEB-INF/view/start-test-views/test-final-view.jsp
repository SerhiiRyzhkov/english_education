    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
            <div class="u-container-layout u-container-layout-1">
                <h1 class="u-align-center u-text u-text-body-alt-color u-text-default u-text-1" data-lang-en="​Lessons &amp;amp; Practice"> STARTING TEST
                </h1>
                <h3 class="u-align-center u-text u-text-2">Your level: ${levelAtt}</h3>
                <h3 class="u-align-center u-text u-text-2">Your result: ${userPointsAtt}/${totalPointsAtt} points</h3>

                <h4 class="u-align-center u-text u-text-3"> ${levelAtt}: ${adviceAtt}
        ...
        <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
            <a href="/homeReff"><div class="u-container-layout u-container-layout-2"  style="left: 75%;">
                <h5 class="u-align-center u-text u-text-default u-text-palette-1-base u-text-4">HOME PAGE</h5>
            </div> </a>
        </div>
