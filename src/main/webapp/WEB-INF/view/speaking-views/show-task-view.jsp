...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/show-task-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/show-task-view/Main.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/show-task-view/clock.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/show-task-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/show-task-view/nicepage.js"/>" defer=""></script>
...
<body data-home-page="Speaking.html" data-home-page-title="Speaking" class="u-body u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-fe69"><div class="u-clearfix u-sheet u-sheet-1">
...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    <div class="u-bottom-left-radius-19 u-container-style u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
        <div class="u-container-layout u-container-layout-1">
            <h1 class="u-align-center u-text u-text-body-alt-color u-text-1" data-lang-en="​Lessons &amp;amp; Practice">SPEAKING PRACTISE</h1>
        </div>
    </div>
    <h3 class="u-align-center u-text u-text-2"> You have exactly one minute to give a detailed answer to each question on a given topic. For convenience, we recommend using a timer. Good luck!<br>
    </h3>
    <h3 class="u-align-center u-text u-text-3" style="color:yellow">${taskAtt.title}</h3>
    <div class="u-align-center u-table u-table-responsive u-table-1">
        <table class="u-table-entity">
            ...
            <c:forEach var="q" items="${questionsAtt}" varStatus="item">
                <tr style="height: 46px;">
                    <td class="u-table-cell">${q.question}"
                    ...
                    <td class="u-table-cell">
                        ...
                        <div class="countdown${item.index}">
                            <div class="countdown-timer${item.index}">
                                <span id="minutes${item.index}">01</span>
                                <span>:</span>
                                <span id="seconds${item.index}">00</span>
                            </div>
                    ...
                    <td class="u-table-cell">
                        ...
                        <img src="<c:url value="/resources/style/show-task-view/7.png"/>" width="64" height="aute" style="cursor: pointer"onclick="startCountdown${item.index}()">
                    </td>
                ...
                <script type="text/javascript">
                    var countdown${item.index} = null;

                    function startCountdown${item.index}() {
                        if (countdown${item.index} === null) {
                            var minutes = 1;
                            var seconds = 0;
                            countdown${item.index} = setInterval(function() {
                                // Display the remaining time
                                document.getElementById("minutes${item.index}").textContent = minutes.toString().padStart(2, '0');
                                document.getElementById("seconds${item.index}").textContent = seconds.toString().padStart(2, '0');
                                ...
                                if (seconds > 0) {
                                    ...
                                    clearInterval(countdown${item.index});
                                    countdown${item.index} = null;
    ...
    <form:form action="/speaking/" name="back">

    </form:form>
    <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
        <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['back'].submit();" style="cursor:pointer">
            <h5 class="u-text u-text-default u-text-palette-1-base u-text-4">BACK</h5>
        </div>
    </div>
</section>
