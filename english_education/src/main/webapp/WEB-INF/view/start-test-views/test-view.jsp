...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    <div class="u-bottom-left-radius-19 u-container-style u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" style="left:10%" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
        <div class="u-container-layout u-container-layout-1" style="left: -15%;">
            <h1 class="u-align-center u-text u-text-body-alt-color u-text-1" data-lang-en="​Lessons &amp;amp; Practice">STARTING TEST</h1>
            <h4 class="u-align-center u-text u-text-2"> Welcome to the English level definition test! This test will help determine your current level of English proficiency. Good luck, and we hope this test will help you on your journey to improve your English skills!</h4>
        </div>
    </div>

    <form:form action="testing" name="begin">

    </form:form>


    <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2" style="right:17%">
        <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['begin'].submit();" style="cursor:pointer">
            <h5 class="u-text u-text-default u-text-palette-1-base u-text-3">BEGIN</h5>
        </div>
    </div>
