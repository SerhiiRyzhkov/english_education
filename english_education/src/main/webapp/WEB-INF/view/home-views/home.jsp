...
<body onload="chatDownFunction()" class="u-body u-stick-footer u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-fe69"><div class="u-clearfix u-sheet u-sheet-1">
...
<section class="skrollable u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-2 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div id="myChat"  style="display: ${openChatAtt};">
            ...
            <div id="DIV_1">
                <div id="DIV_2">
                                        ...
                                        <li class="in">
                                            <div class="chat-body">
                                                ...
                                                <p style="color: #0f0f0f"; margin-top: 7px;
                                                   margin-bottom: 2px;>${mes.key.clock}</p>
                    ...
                    <form:form action="chatSendMessage" cssStyle=" display: flex;
  align-items: center;
  justify-content: space-between;
  background-color: #f5f5f5;
  padding: 10px;
  border-radius: 5px;">
                        <input type="text"  name="messageAtt" style="flex: 1;
  margin-right: 10px;
  padding: 10px;
  border: none;
  border-radius: 5px;">
