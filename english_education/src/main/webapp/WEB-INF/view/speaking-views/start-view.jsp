...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/speaking-start-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/speaking-start-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/speaking-start-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/speaking-start-view/nicepage.js"/>" defer=""></script>
...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    <div class="u-bottom-left-radius-19 u-container-style u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" style="left:10%" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
        <div class="u-container-layout u-container-layout-1" style="left: -15%;">
            <h1 class="u-align-center u-text u-text-body-alt-color u-text-1" data-lang-en="​Lessons &amp;amp; Practice">SPEAKING PRACTISE</h1>
            <h4 class="u-align-center u-text u-text-2"> Welcome to the English Speaking Test! This test is designed to assess your speaking skills in English. Before starting the test, take a deep breath, relax, and remember that you have prepared for this moment. Trust in yourself and your abilities, and do your best to speak clearly and confidently. You will be given prompts to guide your conversation, so read carefully and respond appropriately. Remember, the goal is to communicate effectively and demonstrate your language skills. Good luck, and we hope you enjoy the test!</h4>
        </div>
    </div>

    <form:form action="allTasks/" name="all">

    </form:form>


    <form:form action="randomTaks/" name="random">

    </form:form>

    <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2">
        <div class="u-container-layout u-valign-middle u-container-layout-2" onClick="document.forms['random'].submit();" style="cursor:pointer">
            <h5 class="u-text u-text-default u-text-palette-1-base u-text-3">RANDOM TOPIC</h5>
        </div>
    </div>
    <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-3">
        <div class="u-container-layout u-valign-middle u-container-layout-3" onClick="document.forms['all'].submit();" style="cursor:pointer">
            <h5 class="u-text u-text-default u-text-palette-1-base u-text-4">ALL TOPICS</h5>
        </div>
    </div>
</section>
