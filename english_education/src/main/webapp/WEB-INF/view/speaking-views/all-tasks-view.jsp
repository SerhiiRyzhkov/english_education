...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/all-tasks-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/all-tasks-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/all-tasks-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/all-tasks-view/nicepage.js"/>" defer=""></script>
...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
    ...
    <ul class="u-custom-font u-font-roboto-slab u-spacing-20 u-text u-text-4">
        ...
        <c:forEach var="task" items="${allTasks}">
            ...
            <li onClick="window.location.href='${showTask}'" style="cursor:pointer">${task.title}</li>
