...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/reading-practice-tests-this-level/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/reading-practice-tests-this-level/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/reading-practice-tests-this-level/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript" src="<c:url value="/resources/style/reading-practice-tests-this-level/nicepage.js"/>" defer=""></script>
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
            <div class="u-container-layout u-container-layout-1">
                <h1 class="u-align-center u-text u-text-body-alt-color u-text-1" data-lang-en="​Lessons &amp;amp; Practice">READING PRACTICE<br>${tasksAtt.get(0).level} LEVEL&nbsp;
                </h1>
            </div>
        </div>
