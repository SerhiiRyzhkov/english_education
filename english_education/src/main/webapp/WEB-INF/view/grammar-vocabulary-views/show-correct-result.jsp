...
<body data-home-page="GrammarAndVocabulary.html" data-home-page-title="GrammarAndVocabulary" class="u-body u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-fe69"><div class="u-clearfix u-sheet u-sheet-1">
  ...
  <div class="u-clearfix u-sheet u-valign-top u-sheet-1">
    <div class="u-bottom-left-radius-19 u-container-style u-expanded-width u-group u-palette-1-base u-shape-round u-top-left-radius-19 u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
      <div class="u-container-layout u-container-layout-1">
        ...
        <h3 class="u-align-center u-text u-text-default u-text-2" style="">Question ${indexAtt+1}/${amountAtt}</h3>
      </div>
    </div>
    ...
    <div>
      ...
      <label class="rad-label">
        <input type="radio" class="rad-input" value="1" name="choiceAtt">
        <div class="rad2-design"></div>

    <c:if test="${1==answerAtt}">
      <div class="rad-text" style="color: green!important;">${curQuestionAtt.answer1}</div>
    </c:if>
    <c:if test="${1!=answerAtt and 1==choiceAtt}">
      <div class="rad-text" style="color: red!important;">${curQuestionAtt.answer1}</div>
    </c:if>
    <c:if test="${1!=answerAtt and 1!=choiceAtt}">
      <div class="rad-text" style="color: white!important;" >${curQuestionAtt.answer1}</div>
    </c:if>
    ...
    <c:if test="${2==answerAtt}">
      <div class="rad-text" style="color: green!important;">${curQuestionAtt.answer2}</div>

    </c:if>
    <c:if test="${2!=answerAtt and 2==choiceAtt}">
      <div class="rad-text" style="color: red!important;">${curQuestionAtt.answer2}</div>

    </c:if>
    <c:if test="${2!=answerAtt and 2!=choiceAtt}">
      <div class="rad-text" style="color: white!important;">${curQuestionAtt.answer2}</div>
    </c:if>
    ...
    <c:if test="${3==answerAtt}">
      <div class="rad-text" style="color: green!important;">${curQuestionAtt.answer3}</div>

    </c:if>
    <c:if test="${3!=answerAtt and 3==choiceAtt}">
      <div class="rad-text" style="color: red!important;">${curQuestionAtt.answer3}</div>

    </c:if>
    <c:if test="${3!=answerAtt and 3!=choiceAtt}">
      <div class="rad-text" style="color: white!important;">${curQuestionAtt.answer3}</div>
    </c:if>
      </label>
