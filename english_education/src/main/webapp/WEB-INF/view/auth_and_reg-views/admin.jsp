...
<section class="u-align-center-sm u-align-center-xs u-align-right-lg u-align-right-md u-align-right-xl u-border-4 u-border-palette-2-base u-clearfix u-palette-1-base u-section-1" id="sec-d422">
  ...
  <form:form action="admin/listOfUsers" name="listOfUsers">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-2" onClick="document.forms['listOfUsers'].submit();" style="cursor:pointer">
    <div class="u-container-layout u-valign-middle u-container-layout-2">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-2" >USERS</h5>
    </div>
  </div>

  <form:form action="admin/addNewQuestions" name="addNewQ">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-3" onClick="document.forms['addNewQ'].submit();" style="cursor:pointer">
    <div class="u-container-layout u-valign-middle u-container-layout-3">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-3">ADD NEW SIMPLE QUESTION</h5>
    </div>
  </div>

  <form:form action="admin/addNewListening" name="addListening">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-4" onClick="document.forms['addListening'].submit();" style="cursor:pointer">
    <div class="u-container-layout u-valign-middle u-container-layout-4">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-4">ADD NEW LISTENING</h5>
    </div>
  </div>

  <form:form action="admin/addNewReading" name="addReading">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-5" onClick="document.forms['addReading'].submit();" style="cursor:pointer">
    <div class="u-container-layout u-valign-middle u-container-layout-5">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-5">ADD NEW READING</h5>
    </div>
  </div>
  <form:form action="admin/addWord" name="addW">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-6" onClick="document.forms['addW'].submit();" style="cursor:pointer">
    <div class="u-container-layout u-valign-middle u-container-layout-6">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-6">ADD NEW WORD OF DAY</h5>
    </div>
  </div>

  <form:form action="admin/addSpeaking" name="addSpeak">
  </form:form>
  <div class="u-container-style u-group u-radius-42 u-shape-round u-white u-group-7" onClick="document.forms['addSpeak'].submit();" style="cursor:pointer">
    <div class="u-container-layout u-valign-middle u-container-layout-7">
      <h5 class="u-text u-text-default u-text-palette-1-base u-text-7">ADD NEW SPEAKING</h5>
    </div>
  </div>
</section>
